...
public class MyProfileActivity extends AppCompatActivity {
    ...
    private void call_myprofile_webservice(File imagefile) {
        ...
        Ion.with(MyProfileActivity.this)
                ...
                .setMultipartParameter("buyer_id", app_sharedpreference.getsharedpref("userid", ""))
            ...
            public void onCompleted(Exception e, JsonObject result) {
                ...
                if (result != null) {
                    if (result.get("error").getAsString().contains("false")) {
                        ...
                        app_sharedpreference.setsharedpref("imageurl", profile_pic);
                        String a = app_sharedpreference.getsharedpref("imageurl");
